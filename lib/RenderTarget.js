...
function RenderTarget(width, height, options) {
  ...
  texture.bind();
  gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0 + this.colorAttachments.length, texture.target, texture.handle, 0);
...
RenderTarget.prototype.getColorAttchement = function (index) {
  index = index || 0;
